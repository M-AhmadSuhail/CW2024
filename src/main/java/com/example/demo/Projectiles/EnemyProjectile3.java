...
/**
 * The EnemyProjectile3 class represents a unique projectile fired by an enemy UFO in the game.
 * It extends the Projectile class and includes behavior for managing destruction with a callback.
 */
public class EnemyProjectile3 extends Projectile {
    ...
    private static final String IMAGE_NAME = "UFO-userfire.png";  // The image file for the projectile
    private static final int IMAGE_HEIGHT = 100;  // The height of the projectile image
    private static final int HORIZONTAL_VELOCITY = -10;  // Horizontal speed of the projectile (negative for left movement)

    /**
     * Constructor to create an EnemyProjectile3 with specified initial X and Y positions.
     *
     ...
     */
    public EnemyProjectile3(double initialXPos, double initialYPos) {
    ...
    /**
     * Updates the state of the EnemyProjectile3.
